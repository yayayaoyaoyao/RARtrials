...
#' @aliases pgreater_unknown_var
#' @author Chuyao Xu, Thomas Lumley, Alain Vandal
#' @export pgreater_unknown_var
#' @param par1 current hyperparameters of a Normal-Inverse-Chi-Squared distribution from the control group.
#' @param par2 current hyperparameters of a Normal-Inverse-Chi-Squared distribution from the compared treatment group.
...
pgreater_unknown_var<-function(par1,par2,delta=0,side,...){
